...
- `@minions-dev-prompts/sdk` (npm package)
- `minions-dev-prompts` (PyPI package)
- `@minions-dev-prompts/cli` (npm package)
- The minions-dev-prompts web playground
- The minions-dev-prompts documentation site
