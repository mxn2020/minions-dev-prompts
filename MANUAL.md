# Manual Setup Steps for Minions Dev-prompts
...
Go to **GitHub → mxn2020/minions-dev-prompts → Settings → Secrets and variables → Actions** and add:

| Secret | Description | Where to get it |
|--------|-------------|-----------------|
| `NPM_TOKEN` | npm publish token | [npmjs.com → Access Tokens](https://www.npmjs.com/settings/~/tokens) |
| `PYPI_TOKEN` | PyPI API token for `minions-dev-prompts` | [pypi.org → Account Settings → API tokens](https://pypi.org/manage/account/#api-tokens) |
...
### Web App (Playground)
- **Netlify site name**: `minions-dev-prompts-web`
- **GitHub repo**: `mxn2020/minions-dev-prompts`
- **Base directory**: `apps/web`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/web/dist`
- **Custom domain**: `dev-prompts.minions.wtf`

### Documentation
- **Netlify site name**: `minions-dev-prompts-docs`
- **GitHub repo**: `mxn2020/minions-dev-prompts`
- **Base directory**: `apps/docs`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/docs/dist`
- **Custom domain**: `dev-prompts.minions.help`

### Blog
- **Netlify site name**: `minions-dev-prompts-blog`
- **GitHub repo**: `mxn2020/minions-dev-prompts`
- **Base directory**: `apps/blog`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/blog/dist`
- **Custom domain**: `dev-prompts.minions.blog`
...
|--------|------|------|-------|
| Docs | CNAME | `dev-prompts.minions.help` | _(Netlify subdomain)_ |
| Blog | CNAME | `dev-prompts.minions.blog` | _(Netlify subdomain)_ |
| App  | CNAME | `dev-prompts.minions.wtf` | _(Netlify subdomain)_ |
...
Your packages:
- SDK: [`@minions-dev-prompts/sdk`](https://www.npmjs.com/package/@minions-dev-prompts/sdk)
- CLI: [`@minions-dev-prompts/cli`](https://www.npmjs.com/package/@minions-dev-prompts/cli)
...
Your package: [`minions-dev-prompts`](https://pypi.org/project/minions-dev-prompts/)
...
| Item | Value |
|------|-------|
| Project | `minions-dev-prompts` |
| SDK (npm) | `@minions-dev-prompts/sdk` |
| CLI (npm) | `@minions-dev-prompts/cli` |
| Python (PyPI) | `minions-dev-prompts` |
| GitHub | `github.com/mxn2020/minions-dev-prompts` |
| Docs domain | `dev-prompts.minions.help` |
| Blog domain | `dev-prompts.minions.blog` |
| App domain | `dev-prompts.minions.wtf` |
