...
/**
 * @minions-dev-prompts/cli — CLI for Minions Dev-prompts
 *
...
import { customTypes } from '@minions-dev-prompts/sdk';
...
program
    ...
    .action(() => {
        console.log(chalk.bold('Minions Dev-prompts'));
        console.log(chalk.dim('Reusable prompt templates, prompt chains, and prompt versioning for agent-tasks'));
        console.log('');
        console.log(`  SDK:    ${chalk.cyan('@minions-dev-prompts/sdk')}`);
        console.log(`  CLI:    ${chalk.cyan('@minions-dev-prompts/cli')}`);
        console.log(`  Python: ${chalk.cyan('minions-dev-prompts')}`);
